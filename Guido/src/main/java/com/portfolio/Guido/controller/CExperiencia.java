...
import com.portfolio.Guido.Dto.DtoExperiencia;
import com.portfolio.Guido.entity.Experiencia;
import com.portfolio.Guido.service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody DtoExperiencia dtoexp){
        ...
        Experiencia experiencia = new Experiencia(dtoexp.getNombreE(), dtoexp.getNombreEmpresa(), dtoexp.getFechaE(), dtoexp.getDescripcionE());
